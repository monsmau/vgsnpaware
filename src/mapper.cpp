    ...
    if (restricted_mems != nullptr) {
        ...
        if (trekmer == false) {
            ...
            if (!mems.empty()) {
                ...
                bool altPath = false;
                string allineamentoToStore;
                bool daStampare = false;
                ...
                cout << first_node << endl; */
                    ...
                    if (noMatch == false) {
                        ...
                        if (print == true) { //print align
                            ...
                            stampa.append("{\"identity\": 1.0, \"mapping_quality\": 60,");
                            //cout << "{\"identity\": 1.0, " ;
                            std::string sequenceRead = "\"" + aln.name() + "\"";

                            stampa.append(" \"name\": " + sequenceRead + ",");
                            //cout << " \"name\": " <<  sequenceRead << ",";

                            stampa.append("  \"path\": { \"mapping\": [ ");
                            //cout << "  \"path\": { \"mapping\": [ ";
                            ...
                            if (rc_node1 == true) {
                                ...
                                stampa.append("{\"edit\": [{\"from_length\": " + std::to_string(lOnnode) +
                            ...
                            stampa.append("\"quality\": \"" + base64_encode(aln.quality()) + "\", ");
                            //cout << "\"quality\": \"" << base64_encode(aln.quality()) << "\",";  //forse .quality()

                            stampa.append("\"refpos\": [");
                            //cout << "\"refpos\": [" ;
                            if (!nodesPath.empty()) {
                                    ...
                                    if (nodeTmp.rfind("_alt", 0) == 0) {
                                        ...
                                        if (rc_node1 == true) {
                                            ...
                                            if (pathWrite == numPath) {
                                                stampa.append("{ \"is_reverse\": true, \"name\": \"" + nodeTmp + "\"}");
                                        ...
                                        if (rc_node1 == true) {
                                            ...
                                            if (pathWrite == numPath) {
                                                stampa.append("{ \"name\": \"" + nodeTmp + "\", \"offset\": \"" +
                                                              offsetToWrite + "\"}");
                            ...
                            stampa.append(" \"sequence\": \"" + readToSearch + "\", \"time_used\": 2000.0");
                        ...
                        if(daStampare == true) cout << allineamentoToStore << endl;
                    }
